            ...
            <div class="row">
                <div class="col-lg-3 col-sm-4">
                    <ul class="social-list">
                        ...
                        @endif @if(isset($site['twitter']['value']) && (!isset($site['hide_twitter']['value']) || $site['hide_twitter']['value']!='1'))
                        <li>
                            <a href="{{ $site['twitter']['value'] }}">
                                    <i class="fa fa-twitter"></i>
                                </a>
                        </li>
                        @endif @if(isset($site['google_plus']['value']) && (!isset($site['hide_google_plus']['value']) || $site['hide_google_plus']['value']!='1'))
                        <li>
                            <a href="{{ $site['google_plus']['value'] }}">
                                    <i class="fa fa-google-plus"></i>
                                </a>
                        </li>
                        @endif @if(isset($site['linkedin']['value']) && (!isset($site['hide_linkedin']['value']) || $site['hide_linkedin']['value']!='1'))
                        <li>
                            <a href="{{ $site['linkedin']['value'] }}">
                                    <i class="fa fa-linkedin"></i>
                                </a>
                        </li>
                        @endif @if(isset($site['flickr']['value']) && (!isset($site['hide_flickr']['value']) || $site['hide_flickr']['value']!='1'))
                        <li>
                            <a href="{{ $site['flickr']['value'] }}">
                                    <i class="fa fa-flickr"></i>
                                </a>
                        </li>
                        @endif @if(isset($site['instagram']['value']) && (!isset($site['hide_instagram']['value']) || $site['hide_instagram']['value']!='1'))
                        <li>
                            <a href="{{ $site['instagram']['value'] }}">
                                    <i class="fa fa-instagram"></i>
                                </a>
                        </li>
                        @endif @if(isset($site['youtube']['value']) && (!isset($site['hide_youtube']['value']) || $site['hide_youtube']['value']!='1'))
                        <li>
                            <a href="{{ $site['youtube']['value'] }}">
                                    <i class="fa fa-youtube"></i>
                                </a>
                        </li>
                        @endif @if(isset($site['skype']['value']) && (!isset($site['hide_skype']['value']) || $site['hide_skype']['value']!='1'))
                        <li>
                            <a href="skype:{{$site['skype']['value']}}">
                                    <i class="fa fa-skype"></i>
                                </a>
                        </li>
                        @endif @if(isset($site['tripadvisor']['value']) && (!isset($site['hide_tripadvisor']['value']) || $site['hide_tripadvisor']['value']!='1'))
                        @endif
                    </ul>
                </div>
                <div class=" col-lg-offset-6 col col-lg-3 text-right">
                    <div class="shopping-cart">
                        ...
                        <a class="shopping-cart__content header-button" id="cart" data-target="#" href="{{ route('cart.index') }}" data-toggle="dropdown"
                        ...
                        <a href="#" data-target="#signin" data-toggle="modal">SignIn
                        ...
                        <div id="signin" class="modal fade" role="dialog">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header" style="background-color: black; color:white; text-align: center">
                                       <button type="button" style="color:white" class="close" data-dismiss="modal">&times;</button>
                                       <h3 style="color:white; font-family: -webkit-body">Peek Let LogIn</h3>
                                    ...
                                    <div class="modal-body">
                                        <form class="form-horizontal" role="form" style="padding:10px;">
                                            ...
                                            <div class="form-group row add">
                                                <label class="control-label col-sm-2" style="font-weight: bold" for="uname">User Name: </label>
                                            ...
                                            <div class="form-group row add">
                                                <label class="control-label col-sm-2" style="font-weight: bold" for="password">Password: </label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="password" placeholder="Password" name="password" required>
                                                    <p class="error text-center alert alert-danger" style="display:none"></p>
                                                </div>
                                            </div>
                                            <a style="float: left; margin-left: 5px;"> Forgot Password? </a>
                                        </form>
                                    </div>
                                    <div class="modal-footer" style="text-align: center">
                                        <button class="btn btn-success" type="submit" >SignIn To Your Account</button>
                                        <p> New Here? <a href="#" data-target="#signup" data-toggle="modal"> Create New Account</a></p>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header" style="background-color: black; text-align: center">
                                           <button type="button" style="color:white" class="close" data-dismiss="modal">&times;</button>
                                            <h3 style="color:white; font-family: -webkit-body">Peek Let Sign Up</h3>
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" role="form" style="padding:10px;">
                                                {{ csrf_field() }}
                                                <div class="form-group row add">
                                                    <label class="control-label col-sm-2" style="font-weight: bold" for="fname">First Name: </label>
                                                ...
                                                <div class="form-group row add">
                                                    <label class="control-label col-sm-2" style="font-weight: bold" for="lname">Last Name: </label>
                                                    <div class="col-sm-8">
                        ...
                        <div class="shopping-cart__list dropdown-menu" aria-labelledby="cart">
                            ...
                            <div class="shopping-cart">
                                {{-- <a class="shopping-cart__content header-button" id="cart" data-target="#" href="http://webdesign-finder.com/"
                                            ...
                                            <ul class="cart_list product_list_widget media-list darklinks">
                                                ...
                                                <li class="media">
                                                    ...
                                                    <div class="media-body media-middle">
                                                        ...
                                                        <p class="">{{ $item->options['color'] }} @if($item->options['p_size'])
                                                            <span class="" style="color: black;">({{ strtoupper($item->options['p_size'] )}})</span>                                                            @else
                                                            <span class="" style="color: black;">({{ strtoupper($item->options['p_dimension'] )}})</span>                                                            @endif
                                                        </p>
                                                    </div>
                                                    <div class="media-body media-middle">
